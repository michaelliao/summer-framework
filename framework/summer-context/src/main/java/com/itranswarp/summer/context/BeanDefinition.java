...
public class BeanDefinition implements Comparable<BeanDefinition> {
    ...
    public BeanDefinition(String name, Class<?> beanClass, Constructor<?> constructor, int order, boolean primary, Method initMethod, Method destroyMethod) {
        this.name = name;
        ...
        setInitAndDestroyMethod(initMethod, destroyMethod);
    }

    public BeanDefinition(String name, Class<?> beanClass, String factoryName, Method factoryMethod, int order, boolean primary, Method initMethod,
    ...
    private void setInitAndDestroyMethod(Method initMethod, Method destroyMethod) {
        if (initMethod != null) {
